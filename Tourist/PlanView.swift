        ...
        NavigationStack {
            GeometryReader { geometry in
                ScrollView {
                    ...
                    .padding(.top, 20) // Add padding at the top since we removed the header
...
// MARK: - Interest Selector and Toggle
...
// MARK: - Itinerary Day Detail View and all subsequent code...
// (The rest of your original PlanView.swift file remains unchanged)
